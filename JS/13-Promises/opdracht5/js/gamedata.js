...
const gamePromise = new Promise((resolve, reject) => {
	...
	// console.log("addgames activated")
	setTimeout(() => {
		games.push(...newGames);
		if (newGames.constructor == Array){
			resolve();
			console.log("variable is an array, promise resolved")
			// console.log(games)
		} else {
			reject();
			console.log("Variable is NOT an array, rejecting promise")
			// console.log(games)
		}
	}, 2000);
...
//  new await/async testing
// though I don't entirely understand the instructions.. the exercises are becoming more vague/abstract-ish
