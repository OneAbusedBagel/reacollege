...
document.getElementById("span-2").innerHTML = `It is now ${nu.getHours()}:${nu.getMinutes()}:${nu.getSeconds()}`;
document.getElementById("span-3").innerHTML = `&copy; CodeCrashers – ${nu.getFullYear()}`;
